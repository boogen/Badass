package badass.engine {
	...
	public class Renderer extends badass.engine.EventDispatcher {
		...
		private function initGPUMovieClipShader():void {
			var vertexShaderAssembler:AGALMiniAssembler = new AGALMiniAssembler();
			vertexShaderAssembler.assemble(Context3DProgramType.VERTEX, (["mul vt0, vc6.zw, va0.xy", "add v0, vc6.xy, vt0.xy", "mov vt0, va0", "mov vt4, vc4", "mul vt2, vt4, vc7.z", "mov vt5, vc5", "mul vt3, vt5, vc7.w", "dp4 vt0.x, va0, vt2", "dp4 vt0.y, va0, vt3", "mov vt1, vt0", "add vt0.xy, vt1.xy, vc7.xy", "m44 op, vt0, vc0"]).join("\n"));
